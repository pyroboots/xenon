...
public class ExceptionBuilder
{
    ...
    public static XenonRuntimeException MissingProperty(string property, string type, string? nuance = null)
        => new($"missing property {property} in type {type}" + (nuance is null ? "" : $" ({nuance})"));
